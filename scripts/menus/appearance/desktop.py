...
hight_s1.set_property("width-request", inc.main_const_def - inc.main_const_def / 8)
hight_s1.set_vexpand(True)
hight_s1.set_hexpand(True)
hight_s1.set_draw_value(0)

hight_s2 = gtk.HScale(adjustment=adjustment2)
hight_s2.set_property("width-request", inc.main_const_def - inc.main_const_def / 8)
hight_s2.set_vexpand(True)
hight_s2.set_hexpand(True)
hight_s2.set_draw_value(0)

width_s1 = gtk.HScale(adjustment=adjustment3)
width_s1.set_property("width-request", inc.main_const_def - inc.main_const_def / 8)
width_s1.set_vexpand(True)
width_s1.set_hexpand(True)
width_s1.set_draw_value(0)

width_s2 = gtk.HScale(adjustment=adjustment4)
width_s2.set_property("width-request", inc.main_const_def - inc.main_const_def / 8)
width_s2.set_vexpand(True)
width_s2.set_hexpand(True)
width_s2.set_draw_value(0)

browse_b = gtk.Button(label="Browse")
browse_b.set_property("width-request", inc.main_const_def / 10)

apply_b = gtk.Button(label="Apply")
apply_b.set_property("width-request", inc.main_const_def / 2)

desktop_fixed.add(backgroud_cbtn)

desktop_fixed.move(backgroud_cbtn, inc.win_w / 16, inc.win_h / 6)

desktop_fixed.add(polybar_cbtn)
desktop_fixed.move(polybar_cbtn, inc.win_w / 16, inc.win_h / 6)

desktop_fixed.add(plank_cbt)
desktop_fixed.move(plank_cbt, inc.win_w / 4.3, inc.win_h / 1.33)

desktop_fixed.add(top_l)
desktop_fixed.move(top_l, inc.win_w / 1.35, inc.win_h / 6)

desktop_fixed.add(hight_l1)
desktop_fixed.move(hight_l1, inc.win_w / 1.35, inc.win_h / 4)

desktop_fixed.add(hight_s1)
desktop_fixed.move(hight_s1, inc.win_w / 1.22, inc.win_h / 4.15)

desktop_fixed.add(width_l1)
desktop_fixed.move(width_l1, inc.win_w / 1.35, inc.win_h / 3)

desktop_fixed.add(width_s1)
desktop_fixed.move(width_s1, inc.win_w / 1.22, inc.win_h / 3.15)

desktop_fixed.add(down_l)
desktop_fixed.move(down_l, inc.win_w / 1.35, inc.win_h / 2.4)

desktop_fixed.add(hight_l2)
desktop_fixed.move(hight_l2, inc.win_w / 1.35, inc.win_h / 2)

desktop_fixed.add(hight_s2)
desktop_fixed.move(hight_s2, inc.win_w / 1.22, inc.win_h / 2.015)

desktop_fixed.add(width_l2)
desktop_fixed.move(width_l2, inc.win_w / 1.35, inc.win_h / 1.72)

desktop_fixed.add(width_s2)
desktop_fixed.move(width_s2, inc.win_w / 1.22, inc.win_h / 1.75)

desktop_fixed.add(wal_l)
desktop_fixed.move(wal_l, inc.win_w / 1.35, inc.win_h / 1.5)

desktop_fixed.add(browse_b)
desktop_fixed.move(browse_b, inc.win_w / 1.13, inc.win_h / 1.52)

desktop_fixed.add(apply_b)
desktop_fixed.move(apply_b, inc.win_w / 1.16, inc.win_h / 1.1)
