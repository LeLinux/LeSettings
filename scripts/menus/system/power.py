...
display_l.set_margin_top(inc.win_h / 5)
...
energy_switcher.set_margin_top(inc.win_h / 20)

power_grid = gtk.Grid()
power_grid.add(display_l)
power_grid.attach(display_l, 1, 1, 0, 0)
power_grid.attach_next_to(display_scale, display_l, gtk.PositionType.RIGHT, 1, 1)
power_grid.attach_next_to(energy_l, display_l, gtk.PositionType.BOTTOM, 1, 1)
power_grid.attach_next_to(energy_switcher, energy_l, gtk.PositionType.RIGHT, 1, 1)
power_grid.attach_next_to(battery_l, energy_l, gtk.PositionType.BOTTOM, 1, 1)
