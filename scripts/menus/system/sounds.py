...
volume_l.set_margin_start(inc.win_w / 6)
volume_l.set_margin_top(inc.win_h / 4)
...
output_l.set_margin_start(inc.win_w / 6)
...
input_l.set_margin_start(inc.win_w / 6)
...
balance_l1.set_margin_start(inc.win_w / 6)
...
balance_l2.set_margin_start(inc.win_w / 6)
...
volume_scale = gtk.HScale(adjustment=adjustment1)
...
balance_s1.set_margin_start(inc.win_w / 6)
balance_s1.set_margin_top(inc.win_h / 20)

balance_s2 = gtk.HScale(adjustment=adjustment3)
...
balance_s2.set_margin_start(inc.win_w / 6)
balance_s2.set_margin_top(inc.win_h / 20)
...
sound_grid.attach_next_to(volume_scale, volume_l, gtk.PositionType.RIGHT, 2, 1)
sound_grid.attach_next_to(output_l, volume_l, gtk.PositionType.BOTTOM, 1, 1)
...
sound_grid.attach_next_to(balance_s1, balance_l1, gtk.PositionType.RIGHT, 2, 1)
sound_grid.attach_next_to(input_l, balance_l1, gtk.PositionType.BOTTOM, 1, 1)
...
sound_grid.attach_next_to(balance_s2, balance_l2, gtk.PositionType.RIGHT, 2, 1)
