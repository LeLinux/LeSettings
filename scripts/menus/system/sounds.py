...
volume_l.set_margin_top(inc.win_h / 3.1)
...
output_l.set_margin_top(inc.win_h / 3.1)
...
input_l.set_margin_top(inc.win_h / 3.1)
...
balance_l1.set_margin_top(inc.win_h / 3.1)
...
balance_l2.set_margin_top(inc.win_h / 3.1)
