...
volume_l.set_margin_start(inc.win_w / 8)
volume_l.set_margin_top(inc.win_h / 5)
...
output_l.set_margin_start(inc.win_w / 8)
...
input_l.set_margin_start(inc.win_w / 8)
...
balance_l1.set_margin_start(inc.win_w / 8)
...
balance_l2.set_margin_start(inc.win_w / 8)
...
volume_scale.set_margin_start(inc.win_w / 8)
...
balance_s1.set_margin_start(inc.win_w / 8)
...
balance_s2.set_margin_start(inc.win_w / 8)
