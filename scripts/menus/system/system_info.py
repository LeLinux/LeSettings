...
os_name_l.set_margin_start(inc.win_w/3.2)
os_name_l.set_margin_top(inc.win_h/3.2)

ram_l = gtk.Label("RAM")
ram_l.get_style_context().add_class("label")
ram_l.set_xalign(0)
ram_l.set_property("width-request", inc.main_const_def)
ram_l.set_margin_start(inc.win_w/3.2)
ram_l.set_margin_top(inc.win_h*0.05)

cpu_l = gtk.Label("CPU")
cpu_l.get_style_context().add_class("label")
cpu_l.set_xalign(0)
cpu_l.set_property("width-request", inc.main_const_def)
cpu_l.set_margin_start(inc.win_w/3.2)
cpu_l.set_margin_top(inc.win_h*0.05)

gpu_l = gtk.Label("GPU")
gpu_l.get_style_context().add_class("label")
gpu_l.set_xalign(0)
gpu_l.set_property("width-request", inc.main_const_def)
gpu_l.set_margin_start(inc.win_w/3.2)
gpu_l.set_margin_top(inc.win_h*0.05)
...
os_name_l_data.set_margin_top(inc.win_h/3.2)
...
ram_l_data.set_margin_top(inc.win_h*0.05)
...
cpu_l_data.set_margin_top(inc.win_h*0.05)
...
gpu_l_data.set_margin_top(inc.win_h*0.05)
...
sysinfo_grid.attach_next_to(cpu_l, ram_l, gtk.PositionType.BOTTOM, 1, 1)
