...
system_b.get_style_context().add_class("button")
...
conns_b.get_style_context().add_class("button")
...
devices_b.get_style_context().add_class("button")
...
appearance_b.get_style_context().add_class("button")
