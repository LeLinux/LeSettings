...
system_b.set_property("width-request", inc.main_const)
system_b.set_property("height-request", inc.main_const)
system_b.set_margin_top(inc.main_top_mar)
system_b.set_margin_start(inc.main_const)
...
conns_b.set_property("width-request", inc.main_const)
conns_b.set_property("height-request", inc.main_const)
conns_b.set_margin_top(inc.main_top_mar)
conns_b.set_margin_start(inc.main_const)
...
appearance_b.set_property("width-request", inc.main_const)
appearance_b.set_property("height-request", inc.main_const)
appearance_b.set_margin_top(inc.main_top_mar)
appearance_b.set_margin_start(inc.main_const)
...
devices_b.set_property("width-request", inc.main_const)
devices_b.set_property("height-request", inc.main_const)
devices_b.set_margin_top(inc.main_top_mar)
devices_b.set_margin_start(inc.main_const)
